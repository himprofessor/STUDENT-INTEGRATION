<div class="modal fade" id="confirmDelete{{ $activities->id }}" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-0 text-wrap">Are you sure you want to delete this student activity?</p>
            </div>
