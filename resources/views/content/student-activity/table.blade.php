<table class="table table-hover">
    ...
    <tbody class="table-border-bottom-0">
        ...
        <tr>
            ...
            <td class="hover-row text-wrap" data-bs-toggle="modal" data-bs-target="#confirmView{{ $activities->id }}" style="cursor: pointer; width: 65%;" title="view Image">{!! $activities->description !!}</td>
            <td>
