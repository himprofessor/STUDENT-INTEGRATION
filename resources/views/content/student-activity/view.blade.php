...
{{-- <style>
    #confirmView{{ $activities->id }} .small-card.disabled {
        ...
        #smallCards {
        flex-direction: column; /* Display small cards in one column on mobile devices */
        }
    }
  </style> --}}
    ...
    <div class="modal-dialog modal-dialog-centered modal-sg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- Show small cards in one column on mobile -->
          <div class="d-flex flex-wrap w-100 flex-column d-md-none" id="smallCards">
            @foreach ($activities->media as $key => $medium)
              <div class="mb-3">
                <div class="card small-card @if ($key !== 0) disabled @endif"
                  data-bs-target="#carouselExampleControls{{ $activities->id }}"
          ...
          <!-- Show small cards in multiple columns on larger screens -->
          <div class="d-none d-md-flex flex-wrap w-100" id="smallCards">
            @foreach ($activities->media as $key => $medium)
              <div class="col-md-2 mb-3">
                <div class="card small-card @if ($key !== 0) disabled @endif"
                  data-bs-target="#carouselExampleControls{{ $activities->id }}"
