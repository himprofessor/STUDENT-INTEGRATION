...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-bold">Internship Program Create</h5>
</div>
<div class="row row-2">
    <div class="col-xl">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('internship.store') }}" enctype="multipart/form-data">
                    @csrf
                    @include('content.internships.form')
                    <a href="{{ url('internships-program') }}" class="btn btn-secondary me-1 mt-2">Cancel</a>
...
<script>
    ...
    $(document).ready(function() {
        $('#basic-default-title, #upload, #editor').on('input change file textarea', function() {
