...
@section('title', 'Career Card - UI elements')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-bold">Career Update</h5>
</div>
<div class="row">
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="{{ route('career.update', $career->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    @include('content.career.form', ['career' => $career])
                    <a href="{{ url('career') }}" class="btn btn-secondary">Cancel</a>
