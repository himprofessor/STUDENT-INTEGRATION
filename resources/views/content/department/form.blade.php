...
<div class="mb-3">
  ...
  <div class="card-body">
    <div class="d-flex align-items-start align-items-sm-center gap-4">
      ...
      <img src="{{ old('department_cover', $department->department_cover ?? '') ? asset('storage/' . old('department_cover', $department->department_cover ?? '')) : asset('assets/img/avatars/1.png') }}" 
      alt="department-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
