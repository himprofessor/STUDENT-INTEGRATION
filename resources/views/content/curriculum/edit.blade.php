...
@section('title', 'Curriculum Card - UI elements')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-bold">Curriculum Update</h5>
</div>
<div class="row">
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="{{ route('curriculum.update', $curriculum->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    @include('content.curriculum.form', ['curriculum' => $curriculum])
                    <a href="{{ url('curriculum') }}" class="btn btn-secondary">Cancel</a>
...
<script>
    ...
    // Javascript crop image curriculum
    $(document).ready(function() {
